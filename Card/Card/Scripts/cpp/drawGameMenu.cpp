...
void drawGameMenu() {
	...
	DrawBox(10, 40, 300, 200, Cr[0] = GetColor(0, 80, 150), TRUE);
	DrawBox(10, 40, 300, 200, Cr[1] = GetColor(255, 255, 250), FALSE);
    ...
    */
	...
	DrawString(30, 70, "戦力詳細", Cr[0] = (0, 0, 0));
	DrawString(150, 45, "設定", Cr[0] = (0, 0, 0));
	DrawString(150, 70, "ギブアップ", Cr[0] = (0, 0, 0));
